                ...
                <div class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @if ($futsal->shower_facility)
                            <span class="bg-green-50 text-green-700 px-3 py-1 rounded-full text-sm font-medium">🚿 Shower
                                Facility</span>
                        @endif
                        @if ($futsal->parking_space)
                            <span class="bg-green-50 text-green-700 px-3 py-1 rounded-full text-sm font-medium">🚗 Parking
                                Space</span>
                        @endif
                        @if ($futsal->changing_room)
                            <span class="bg-green-50 text-green-700 px-3 py-1 rounded-full text-sm font-medium">👕 Changing
                                Room</span>
                        @endif
                        ...
                        @if ($futsal->open_ground)
                            <span class="bg-green-50 text-green-700 px-3 py-1 rounded-full text-sm font-medium">🏞️ Open
                                Ground</span>
                        @endif
                        @if (

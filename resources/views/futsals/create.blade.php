...
<section class="space-y-2 mt-6">
    ...
    <label
        class="border-2 border-dashed rounded-lg flex flex-col items-center justify-center h-60 cursor-pointer hover:bg-gray-50 transition relative overflow-hidden">
        <span id="photo-text" class="text-gray-400">Click to upload (Required)</span>

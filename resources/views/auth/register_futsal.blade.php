    ...
    <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-10">
        ...
        <form action="{{ route('register.futsal.form') }}" method="POST" enctype="multipart/form-data">
            ...
            <section class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="Gmail Address *"
                        class="border p-3 rounded-lg w-full focus:ring-2 focus:ring-green-500">
                    <input type="number" name="price" value="{{ old('price') }}" placeholder="Price per hour (NPR) *"
                        class="border p-3 rounded-lg w-full focus:ring-2 focus:ring-green-500">
            ...
            <section class="space-y-4 mt-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <input type="number" name="side_no" min="0" value="{{ old('side_no') }}" placeholder="Players per side" class="border p-3 rounded-lg w-full">
                    <input type="number" name="ground_no" min="0" value="{{ old('ground_no') }}" placeholder="Number of Grounds" class="border p-3 rounded-lg w-full">
                </div>
            ...
            <section class="space-y-2 mt-6">
                ...
                <label class="border-2 border-dashed rounded-lg flex flex-col items-center justify-center h-96 cursor-pointer hover:bg-gray-50 transition relative overflow-hidden">
            ...
            <div class="flex justify-between mt-6">
                <a href="{{ url()->previous() }}" class="border border-gray-300 px-4 py-2 rounded-lg hover:bg-gray-100">← Back</a>

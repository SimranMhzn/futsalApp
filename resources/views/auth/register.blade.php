...
<div class="mt-8 flex flex-col items-center">
    <form class="max-w-md w-full bg-green-50 p-8 rounded-xl shadow-lg" action="{{ route('register') }}" method="POST">
        ...
        <div class="mb-5">
            ...
            <input type="phone" id="phone" name="phone" class="bg-white border border-green-300 text-green-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" placeholder="Enter your contact number" required />
        </div>
        <div class="mb-5">
